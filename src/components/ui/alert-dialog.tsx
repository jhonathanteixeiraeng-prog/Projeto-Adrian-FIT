...
// import { buttonVariants } from "@/components/ui/button" // Assuming buttonVariants are exported from button.tsx, if not I'll use standard classes

// Simplified version without buttonVariants dependency for safety
